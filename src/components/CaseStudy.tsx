    ...
    <section id="fallstudie" className="mx-auto w-full max-w-6xl px-6 py-12">
      <div className="mb-6 text-center">
        ...
        <p className="mx-auto mb-4 max-w-3xl text-sm text-slate-600">
          Für einen lokalen Fachhandel für Sammelkarten in München wurde über mehrere Monate hinweg
          eine gezielte Local-SEO-Optimierung umgesetzt. Ausgangspunkt war eine sehr geringe Sichtbarkeit
          außerhalb des direkten Standorts. Ziel war es, die Google-Maps-Positionen im gesamten
      ...
      <div className="mb-4 grid gap-4 md:grid-cols-2">
        <article className="rounded-lg border border-slate-200 bg-white p-4">
          ...
          <p className="mb-3 text-xs leading-relaxed text-slate-600">
            ...
            <br />
            Zu Beginn war das Unternehmen in vielen Bereichen Münchens kaum sichtbar. In zahlreichen
            Stadtteilen lag die Position bei 20+ und potenzielle Kunden außerhalb des direkten Umfelds
            wurden über Google Maps nicht erreicht.
          </p>
      ...
      <div className="mb-3 rounded-lg border border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-4">
        <p className="text-center text-sm text-slate-700">
          ...
          Relevanzsignale führte zu deutlich verbesserter Sichtbarkeit im gesamten Stadtgebiet.
        </p>
      </div>

      <p className="mx-auto max-w-3xl text-center text-xs text-slate-500">
        Die dargestellte Fallstudie basiert auf einem realen Kundenprojekt. Ergebnisse können je nach
